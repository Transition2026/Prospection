...
export default function SearchForm({ onSearch, loading, categoryFilter, onCategoryChange, exclureGroupes, onExclureGroupesChange }) {
  ...
  function submit(event) {
    ...
    const params = { sections, limit: limit === 'all' ? 'all' : Math.min(Math.max(Number(limit) || 25, 1), 2000), per_page: 25 };
